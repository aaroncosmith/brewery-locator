    ...
    results.forEach(function(eaResult) {
        ...
        <li class="list-group-item">
            ...
            <div class="address-link">
                <a target="_blank" href="https://www.google.com/maps/dir/Current+Location/${eaResult.street},${eaResult.city},${eaResult.state},${eaResult.postal_code} $">${eaResult.street}, ${eaResult.city}, ${eaResult.state}, ${eaResult.postal_code}</a>
            </div>
            <div class="website">
                <a target="_blank" href="${eaResult.website_url}">Go to Brewery Website</a>
            </div>
        </li>
        `
    }) 
